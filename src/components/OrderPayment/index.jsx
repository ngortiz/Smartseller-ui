  ...
  return (
    <div className='column-content'>
      ...
      <p>
        ...
        {t(`orderPayment.states.${paymentState.toLowerCase()}`)}
      </p>
      <p>
        <strong>{t('orderPayment.total')}:</strong> <label>{total}</label>
      </p>
      <p>
        <strong>{t('orderPayment.totalPaid')}:</strong> <label>{totalPaid}</label>
      </p>
      <p>
        <strong>{t('orderPayment.totalDebt')}:</strong> <label>{totalDebt}</label>
      </p>
    </div>
  )
}
